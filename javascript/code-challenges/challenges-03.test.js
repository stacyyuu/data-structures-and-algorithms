...
const getBaseStatGreaterThan = (arr, minBaseStat) => arr.filter(obj => minBaseStat < obj.baseStat);
// Solution code here...
...
const getStatName = (arr, minBaseStat) => arr.filter(obj => minBaseStat < obj.baseStat).map(obj => obj.stat.name);
// Solution code here...
