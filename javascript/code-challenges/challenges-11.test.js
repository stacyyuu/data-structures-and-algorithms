...
let findMaleAndFemale = (data) => data.filter(obj => obj.gender === 'male' || obj.gender === 'female').map(obj => obj.name).join(' and ');
...
let findShortest = (data) => data.reduce((prev, curr) => +prev.height < +curr.height ? prev : curr).name;
